...
class StaffController{
	...
	public function editRequest() {
		...
		$request->editRequest($request->getName(),$request->getCheckin(),$request->getCheckout(),$request->getHotel(),$request->getProgram(),$price,$status);
	}
	...
	public function insertPackage() {
		...
		$this->packagemodel->getPackage($_REQUEST['id'])->insertPackage($name,$checkin,$checkout,$hotel,$program,$price);
	}
